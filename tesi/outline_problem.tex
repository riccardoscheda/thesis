...
In this Chapter we present the theoretical model of Gene Regulatory Networks based on Random Boolean Networks, in order to estimate a theoretical fitness potential for cell differentiation.

\section{Assumptions for the theoretical model}
...
satisfy this condition, but the metadynamic network realizew a reversible Markov process. The existence of a thermodynamic equilibrium
