...
stationary state (see figure \label{schema1}). If a node is accidentally set to zero this anomaly propagates in the loop, 
...
\begin{figure}[h]
\label{fig:crit} 
\centering{\includegraphics[scale=1.3]{theta.png}}
